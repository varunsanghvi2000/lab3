...
L1 = 3;          %base height (in in)
L2 = 5.75;       %shoulder to elbow length (in in)
L3 = 7.375;      %elbow to wrist length (in in)
L4 = 1.75;       %Wrist1 to Wrist2 (in in)
L5 = 1.25;       %wrist2 to base of gripper (in in)
L6 = 1.125;      %gripper length

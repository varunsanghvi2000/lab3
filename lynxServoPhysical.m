...
P1 = (q(1) + servoOffsets(1) + (pi/2)) * (180/pi/0.102);
P2 = (q(2) + servoOffsets(2) - (pi/2)) * (180/pi/0.105);
P3 = (q(3) + servoOffsets(3) + pi) * (180/pi/0.109);
P4 = (q(4) + servoOffsets(4) + pi) * (180/pi/0.095);
P5 = (q(5) + servoOffsets(5) + (pi/2)) * (180/pi/0.102);
P6 = (q(6) + servoOffsets(6)) / -0.028; 
